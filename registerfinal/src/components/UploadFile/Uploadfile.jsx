...
export const Uploadfile = ({ registerForm }) => {
  const ekUpload = () => {
    ...
    const fileSelectHandler = (e) => {
      // Fetch FileList object. The files property of DataTransfer objects is a list of the files in the drag operation
    ...
    if (window.File && window.FileList && window.FileReader) {
      //llama a la callback del evento que coge la imagen
      Init();
    } else {
